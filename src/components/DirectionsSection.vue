    ...
    <div v-reveal class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-5 sm:gap-6">
        <div class="reveal-item delay-100 lg:col-span-2">
          <div class="relative overflow-hidden rounded-3xl border border-slate-800/80 min-h-[320px] sm:min-h-[360px] p-6 sm:p-8 flex flex-col justify-between group transition-all duration-300 hover:border-emerald-500/50 hover:shadow-2xl hover:shadow-emerald-500/10">
            <img 
              :src="genetics" 
