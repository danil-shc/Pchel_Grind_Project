<script setup>
import { Rocket, FileText, Award, ExternalLink, ShieldCheck } from 'lucide-vue-next'
</script>
  ...
  <section class="w-full py-6 sm:py-10 md:py-14 border-t border-slate-200/60 dark:border-slate-800/60">
    <div v-reveal class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 gap-6">
        <!-- Главная карточка: Стартап RARE-ID -->
        <div class="reveal-item delay-100 bg-slate-900/50 backdrop-blur-md border border-slate-800 p-6 sm:p-8 rounded-2xl sm:rounded-3xl hover:border-emerald-500/40 transition-all duration-300 group">
          <div class="flex flex-col sm:flex-row gap-6">
            <div class="shrink-0">
              <div class="w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-linear-to-br from-emerald-500/20 to-cyan-500/20 border border-emerald-500/30 flex items-center justify-center">
                <Rocket :size="28" class="text-emerald-400" />
              </div>
            </div>
            <div class="flex-1">
              <div class="mb-3">
                <span class="inline-flex items-center gap-1.5 px-3 py-1 text-[10px] sm:text-xs font-bold rounded-full border border-cyan-500/30 bg-cyan-500/10 text-cyan-400 uppercase tracking-wider">
              ...
              <div class="flex flex-wrap gap-2">
                <span class="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold rounded-lg bg-slate-800/80 border border-slate-700/80 text-slate-300">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div class="reveal-item delay-200 bg-slate-900/50 backdrop-blur-md border border-slate-800 p-6 rounded-2xl sm:rounded-3xl hover:border-amber-500/40 transition-all duration-300">
            ...
            <h3 class="text-lg sm:text-xl font-bold mb-4 text-white">Патенты и интеллектуальная собственность</h3>
            <div class="space-y-4">
